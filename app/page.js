        ...
        <div className="animate-fadeIn">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Link href="/register" className="px-6 py-3 bg-secondary-400 text-gray-900 rounded-lg hover:bg-secondary-300 transition-all duration-300 font-semibold shadow-lg">
                                    Book Now
                                </Link>
                            </div>
                        </div>
            ...
            <section className="py-16 hero-gradient text-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <Link href="/register" className="px-8 py-4 bg-secondary-400 text-gray-900 rounded-lg hover:bg-secondary-300 transition-all duration-300 font-bold text-lg shadow-lg inline-block">
                        Get Started Now
                    </Link>
                </div>
            </section>
